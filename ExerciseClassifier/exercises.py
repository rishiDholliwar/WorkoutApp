...
def main(inputFiles):   
    exercises_df = pd.read_csv(inputFiles[0])
    exercises_df['Action'] = 'NA'
    ...
    exercises_df = insertAction(exercises_df,49.0,53.0,"Down") #going down for situps
    ...
    exercises_df.to_csv("output.csv",index=False)
